...
# Form implementation generated from reading ui file 'addpeer.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "When you opened this dialog box, you had X peers in your list of peers.", None))
        self.label_2.setText(_translate("Dialog", "You can manually add a peer here:", None))
